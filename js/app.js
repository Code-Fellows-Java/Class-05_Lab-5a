...
Third element: "4 and 7 and 5 sum to 16."a
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    let totalSum = sum(c, resultSum)[0]; 
    let sumString = `${a} and ${b} and ${c} sum to ${totalSum}.`;
    let multiplySum = multiply(a,b)[0];
    let totalMultiplySum = multiply(c, multiplySum)[0];
    let multiplyString = `The product of ${a} and ${b} and ${c} is ${totalMultiplySum}.`;
    return [totalSum, totalMultiplySum, sumString, multiplyString ];
}
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    let multString = "The numbers 2,3,4 have a product of " + product + ".";
